package fullstack.oblig2.oblig2.model;
...
public class Address
{
     ...
     */
    public Address(String _country, String _county, short _zipCode, short _buildingNumber, String _streetName, String _city, int _additionalNumbers)
    {
     ...
     * @param _city
     */
    public Address(String _country, String _county, short _zipCode, short _buildingNumber, String _streetName, String _city)
    {
        this._country = _country;
        this._county = _county;
        this._zipCode = _zipCode;
